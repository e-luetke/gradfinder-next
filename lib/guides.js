// lib/guides.js — GradFinder guide articles
    ...
    sections: [
      {
        heading: null,
        paragraphs: [
          'GradFinder covers graduate programs across both the United States and Canada, and for many applicants — especially international students — the choice between countries is as important as the choice between programs. The differences are real and worth understanding before you apply.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Most programs covered on GradFinder are in English, including all programs at anglophone Canadian universities (UBC, Toronto, Waterloo, McGill English programs, Dalhousie, etc.). McGill and several other Montreal institutions offer some programs in both English and French, and Montréal itself is a bilingual city. The few fully francophone programs (Université de Montréal, Université Laval) are not currently listed on GradFinder.',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Many geography programs allow students to specialize in GIS/GIScience as a concentration within a broader geography MA or MS. Dedicated GIScience programs (GradFinder lists these separately) offer more technical depth and are popular with students who want applied geospatial careers rather than academic research positions. The skills transfer well into fields like urban planning, environmental management, and public health.',
        ],
      },
      {
